...
```
- **`--verification {verified,unverified,deverified,any}`**: Filter offers by verification status (default: `unverified`).
...
**Examples:**
```bash
python3 vast_machine_tester.py --verification unverified --host_id any --ignore-requirements
python3 vast_machine_tester.py --verification any -vv
```
