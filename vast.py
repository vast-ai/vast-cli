...
@parser.command(
    ...
    argument("disk_id", help="id of network volume to attach to machines in the cluster", type=int, nargs="?", default=None),
    usage="vastai add network disk MOUNT_PATH MACHINES [DISK_ID]",
)
