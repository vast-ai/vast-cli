...
@parser.command(
    ...
    argument("--endpoint_name", help="deployment endpoint name (allows multiple worker groups to share same deployment endpoint)", type=str),
    argument("--endpoint_id",   help="deployment endpoint id (allows multiple worker groups to share same deployment endpoint)", type=int),
    ...
    help="Create a new worker group",
    epilog=deindent("""
        Create a new worker group to manage a pool of worker instances.
...
@parser.command(
    argument("id", help="id of worker group to update", type=int),
    ...
    help="Update an existing worker group",
    epilog=deindent("""
